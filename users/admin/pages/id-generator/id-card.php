...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMSv1/users/admin/pages/id-generator/id-card.css">
        ...
        <div class="col-md-6 offset-md-3">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">User ID Card</h4>
                </div>
                <div class="card-body">
                    <div class="text-center">
                        <div class="image-upload">
                            <label for="avatar-upload">
                                <img src="/path/to/user-avatar.jpg" alt="User Avatar" class="rounded-circle img-thumbnail" style="width: 100px; height: 100px;" id="avatar-preview">
                                <div class="overlay">
                ...
                <div class="card-footer bg-primary text-center">
                    <button onclick="generateQRCode()" class="btn btn-light">Generate QR Code</button>
                </div>
            </div>
        </div>
    </div>
</div>
<!-- End of ID Card Generator -->


    <!-- Include the QRCode.js library (for generating QR codes) before this script -->
<script src="/LibMSv1/resources/qrcodejs-master/qrcode.min.js/qrcode.min.js"></script>
    ...
    document.getElementById("avatar-upload").addEventListener("change", function(event) {
        ...
        if (file) {
            ...
            reader.onload = function() {
                document.getElementById("avatar-preview").setAttribute("src", reader.result);
            };
