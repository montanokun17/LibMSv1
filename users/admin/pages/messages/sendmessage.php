...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMSv1/users/admin/pages/messages/css/sendmessage.css">
        ...
        <hr>
            <form>
                <div class="form-group">
                    <label for="receiver">Receiver ID Number:</label>
                    <input type="text" class="form-control" id="receiver" name="receiver" placeholder="ID Number" required>
                </div>
                <div class="form-group">
                ...
                <button type="reset" class="btn btn-secondary"><i class="fa-solid fa-broom"></i> Clear</button>

                <script>
                    const clearButton = document.querySelector('.btn-secondary');
                    const inputField = document.querySelector('#message');
                    const inputField2 = document.querySelector('#receiver');
