...
<head>
    ...
    <title>Admin - Issue/Return Requests</title>
    <!--Link for Tab ICON-->
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMSv1/users/admin/pages/requests/css/requests.css">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light"> 
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="/v1/users/admin/index.php">
...
<div class="main">
        <div class="container">
            <h3 class="title">Issue/Return Requests</h3>
            <hr><br>
                ...
                <div class="container-fluid">
                    <ul class="main-box">
                      ...
                      <li class="txt-box">
                        ...
                        <span class="sub-item">
                          <em> A request made by a user to borrow a specific book from the library's collection for a specific period of time.</em>
                        </span>
                      </li>
    
                      <li class="btn">
                        <a href="/LibMSv1/users/admin/pages/requests/issue.php">
                            <button type="button" class="btn btn-primary"><i class="fa-solid fa-book-open"></i> Issue Request</button>
                        </a>
                      </li>
                      <hr>
                      ...
                      <li class="txt-box">
                        ...
                        <span class="sub-item">
                          <em> A request made by a user to extend the borrowing period of a book that is currently checked out from the library, 
                            subject to the library's renewal policy. </em>
                        </span>
                      </li>
    
                      <li class="btn">
                        <a href="/LibMSv1/users/admin/pages/requests/renew.php">
                            <button type="button" class="btn btn-primary"><i class="fa-solid fa-bookmark"></i> Renew Request</button>
                        </a>
                      </li>
                      <hr>
                      ...
                      <li class="txt-box">
                        ...
                        <span class="sub-item">
                          <em> A request made by a user to return a book borrowed from the library's collection on or before its due date.</em>
                        </span>
                      </li>
    
                      <li class="btn">
                        <a href="/LibMSv1/users/admin/pages/requests/return.php">
                            <button type="button" class="btn btn-primary"><i class="fa-solid fa-book"></i> Return Request</button>
                        </a>
                      </li>
                      <hr>
