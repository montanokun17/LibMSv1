...
<head>
    ...
    <title>Admin - Renew Request</title>
    <!--Link for Tab ICON-->
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMS/users/admin/pages/requests/css/renew.css">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#"><i class="fa-solid fa-database fa-sm"></i> Database</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/LibMS/users/admin/pages/requests/requests.php"><i class="fa-solid fa-arrow-left fa-sm"></i> Go Back</a>
              </li>
            </ul>
    ...
    <div class="container">
        ...
        <thead>
             <tr>
                ...
                <th>Date of the End of Renewal</th>
                <th>Action</th>
                </tr>
        </thead>
        ...
        <tbody>
            ...
            <td>04/27/2023</td>
            <td>
            <button type="button" class="btn btn-success btn-sm"><i class="fa-solid fa-check fa-sm"></i> Grant Renew Request</button>
            <button type="button" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash fa-sm"></i> Delete</button>
            </td>
            </td>
        </tbody>
        </table>
