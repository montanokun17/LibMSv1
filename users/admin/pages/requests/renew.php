...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMSv1/users/admin/pages/requests/css/renew.css">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/LibMSv1/users/admin/pages/requests/requests.php"><i class="fa-solid fa-arrow-left fa-sm"></i> Go Back</a>
              </li>
            </ul>
