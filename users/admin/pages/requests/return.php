...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMS/users/admin/pages/requests/css/return.css">
...
<div class="main">
    <div class="container">
        ...
        <tbody>
            ...
            <td></td>
            <td>
                <button type="button" class="btn btn-success btn-sm"><i class="fa-solid fa-check fa-sm"></i> Confirm Returned Book</button>
            </td>
        </tbody>
        </table>
