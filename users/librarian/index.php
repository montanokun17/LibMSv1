...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMSv1/users/librarian/css/index.css">
    <!--Link for NAVBAR and Sidebar CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMSv1/users/librarian/css/navbar-sidebar.css">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page"
                       href="/LibMSv1/users/librarian/index.php"><i class="fa-solid fa-user fa-xs"></i> Profile Card</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/LibMSv1/users/librarian/"><i
...
<nav class="main-menu">
    <ul>
        <li>
            <a href="/LibMSv1/users/librarian/index.php">
        ...
        <li>
            <a href="/LibMSv1/users/librarian/#">
