...
<head>
    ...
    <!--Link for CSS File-->
    <link rel="stylesheet" type="text/css" href="/LibMSv1/users/admin/pages/profile/css/edituserinfo.css">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light"> 
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="/LibMSv1/users/admin/pages/index.php"><i class="fa-solid fa-user fa-xs"></i> Profile Card</a>
              </li>
              <li class="nav-item">
...
<!--SIDEBAR END-->
    ...
    <!--FORM CARD START-->
      <div class="formcard">
        <div class="container">
            <h3 class="title">Edit User Account's Info</h3>
            <hr>
            <div class="col-md-6">
                ...
                <a href="/LibMSv1/users/admin/pages/profile/userdetails.php">
                    <button type="button" class="btn btn-primary"><i class="fa-solid fa-rotate-left"></i> Go Back <em>(User Account's Info)</em></button>
                </a>
            </div>
        </div>
      </div>
