...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="/LibMSv1/css/bootstrap.css" />

  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Poppins:400,600,700&display=swap" rel="stylesheet">
  <!-- Custom styles for this template -->
  <link href="/LibMSv1/css/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="/LibMSv1/css/responsive.css" rel="stylesheet" />
</head>
...
<body>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container pt-3">
          <a class="navbar-brand mr-5" href="index.html">
            <img src="Pasig City Library" alt="">
            <span>
              Pasig City Library
            </span>
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/LibMSv1/main/login.php">Log In</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/LibMSv1/main/signup.php/">Sign Up</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <section class="about_section layout_padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="img-box">
            <img src="/LibMSv1/resources/images/lib1.png" alt="">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="box">
              <div class="img-box">
                <img src="/LibMSv1/resources/images/s-1.png" alt="">
              </div>
              <h4>
                Free Account
              </h4>
          ...
          <div class="col-md-6">
            <div class="box align-items-end align-items-md-start text-right text-md-left">
              <div class="img-box">
                <img src="/LibMSv1/resources/images/s-2.png" alt="">
              </div>
              <h4>
                User Friendly
              </h4>
  ...
  <section class="container-fluid footer_section">
    <p>
      ...
      <a>MyLibro-Online Library Management System for Pasig City Library</a>
    </p>
  </section>
  <!-- footer section -->

  <script type="text/javascript" src="/LibMSv1/resources/js/jquery-3.4.1.min.js"></script>
  <script type="text/javascript" src="/LibMSv1/resources/js/bootstrap.js"></script>
